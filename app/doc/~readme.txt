Installing the TableViewer App
...
The following line of code will install the TableViewer App
>> appinfo = matlab.apputil.install('TableViewer.mlappinstall')     
