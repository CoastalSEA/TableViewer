classdef TVparameters < muiPropertyUI                 
%
%-------class help---------------------------------------------------------
% NAME
%   TVparameters.m
% PURPOSE
%   Class for input parameters for the TableViewer App
% USAGE
%   obj = TVparameters.setInput(mobj); %mobj is a handle to Main UI
% SEE ALSO
...
%%   
    methods (Access=protected)
        function obj = TVparameters(mobj)         
            %constructor code:            
...
%%  
    methods (Static)  
        function obj = setInput(mobj,editflag)
            ...
            classname = 'TVparameters';               
            obj = getClassObj(mobj,'Inputs',classname);
            if isempty(obj)
                obj = TVparameters(mobj);             
            end
